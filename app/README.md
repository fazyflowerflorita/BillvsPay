...
- Consolidate scenario-based records before matching, including expenses, sick leave, and monthly billing.
...
The reconciliation engine supports the additional scenarios below:

- Expense consolidation: Payroll may show one expense payment while Billing may split the same expense across multiple transactions and dates. Expense rows are consolidated by employee, earning/category code, and month before amount matching.
- Monthly billing: If the Billing report contains monthly billing periods, weekly Payroll rows are consolidated by employee, earning/category code, and month before matching.
- Rounded-off differences: Amount differences below `$1.00` are treated as rounding and marked `Rounded Off Difference`.
- Sick Leave consolidation: Split Sick Leave Payroll and Billing transactions are consolidated by employee, earning/category code, and month before matching hours and amount.
...
- `Tallied`
- `Tallied - Consolidated Expense`
- `Tallied - Consolidated Sick Leave`
- `Tallied - Monthly Billing`
...
- Green: `Tallied`
- Green: consolidated matches such as Expense, Sick Leave, and Monthly Billing
- Light green: `Rounded Off Difference`
